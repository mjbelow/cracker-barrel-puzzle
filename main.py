...
def init(rows_count, first):
    ...
    if first:
        ...
        limit_options.place(relx=0.5,y=yTopOffset+30,x=-170, width=80)
        ...
        peg_count_options.place(relx=0.5,y=yTopOffset+30,x=175, width=80)
        ...
        operator.place(relx=0.5,y=yTopOffset+30,x=90, width=80)
    else:
